...
def transform_to_txt2img_workflow(data):
    ...
    try:
        ...
        # Check if it's a closed-source model (DALL-E, FLUX, Ideogram, Luma, Stability, etc.)
        closed_source_models = [
            'dall-e-3', 'dall-e-2',
            'flux-pro', 'flux-dev',
            'ideogram-v3',
            'photon-1', 'photon-flash-1', 'ray-2', 'ray-flash-2', 'ray-1-6',
            'sd3.5-large', 'sd3.5-medium', 'stable-image-ultra'
        ]
        ...
        elif (model_name in ['photon-1', 'photon-flash-1', 'ray-2', 'ray-flash-2', 'ray-1-6']) or ('luma' in model_name.lower()):
            workflow_model_type = 'luma'
        elif (model_name in ['sd3.5-large', 'sd3.5-medium', 'stable-image-ultra']) or ('stability' in model_name.lower()):
