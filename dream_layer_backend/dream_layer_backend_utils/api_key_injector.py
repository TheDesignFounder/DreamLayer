...
def inject_api_keys_into_workflow(workflow: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if needed_env_keys:
        ...
        elif "COMFY_API_KEY" in needed_env_keys and "COMFY_API_KEY" in all_api_keys:
            api_key_comfy_org = all_api_keys["COMFY_API_KEY"]
            print(f"[DEBUG] Using COMFY_API_KEY for api_key_comfy_org")
        else:
            print(
